...
s=s.replace('// @version      0.2.30','// @version      0.2.31',1)
s=s.replace("const VERSION = '0.2.30';","const VERSION = '0.2.31';",1)
...
if '// @version      0.2.31' not in s or "const VERSION = '0.2.31';" not in s:
    raise SystemExit('Version bump failed')
if 'v0.2.31 cross-device text and spacing safety' not in s:
    raise SystemExit('Responsive override missing')
