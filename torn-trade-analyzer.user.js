...
// @version      0.2.5
// @description  Torn cash-flow, spending, earnings, net-worth and trade analytics with a Bento dashboard, Shadow DOM floating launcher, TCT daily flow and fast sync modes. Data stays on-device.
...
(() => {
  ...
  function getFabHost() {return document.getElementById('tta-fab-host');}
